            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary card-link">Dodaj znajomych!</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 pt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary card-link">Przeglądaj!</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 pt-5">
                <div class="card">
                    <img src="zdjecie.png" class="card-img-top">
                    <div class="card-body">
                        <h4 class="card-title">WOman i kobity kurna XD</h4>
                        <h3 class="card-subtitle">Po co one</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                            Rerum necessitatibus hic vitae unde repellat incidunt 
                            laudantium velit nobis itaque culpa, illo dolor quisquam cum, 
                            temporibus ipsum laborum ullam nostrum corporis.</p>
                        <a href="#" class="btn btn-primary card-link">Zobacz</a>
                    </div>
                </div>
            </div>
        </div>
